package com.invin.fingerprintlocker.util;
...
/**
 * UI Helper to manage text/icon around the finger print authentication UI.
 */
public class FingerPrintUIHelper extends FingerprintManager.AuthenticationCallback {
    ...
    public boolean isFingerprintAuthAvailable() {
        ...
        try {
            isFingerprintAuthAvailable = mFingerprintManager.isHardwareDetected() && mFingerprintManager.hasEnrolledFingerprints();
    ...
    public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
        ...
        mErrorTextView.setTextColor(mErrorTextView.getResources().getColor(R.color.color_success, null));
    ...
    private void showError(CharSequence error) {
        ...
        mErrorTextView.setTextColor(mErrorTextView.getResources().getColor(R.color.color_warning, null));
        mErrorTextView.removeCallbacks(mResetErrorTextRunnable);
    ...
    Runnable mResetErrorTextRunnable = new Runnable() {
        ...
        public void run() {
            mErrorTextView.setTextColor(
                    mErrorTextView.getResources().getColor(R.color.color_hint, null));
